 ...
 */
final class Version20240501174908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipes ADD user_id INT DEFAULT NULL, ADD image VARCHAR(255) NOT NULL, CHANGE ingredients ingredients VARCHAR(1000) DEFAULT NULL');
        $this->addSql('ALTER TABLE recipes ADD CONSTRAINT FK_A369E2B579F37AE5 FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('CREATE INDEX IDX_A369E2B579F37AE5 ON recipes (user_id)');
    }
